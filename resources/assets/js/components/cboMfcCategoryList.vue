  ...
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-crumbs>
        <md-part-toolbar-crumb>厂牌分类</md-part-toolbar-crumb>
        <md-part-toolbar-crumb>列表</md-part-toolbar-crumb>
      </md-part-toolbar-crumbs>
    </md-part-toolbar>
    <md-part-body>
      <md-query @select="select" @dblclick="edit" @init="initQuery" ref="list" md-query-id="suite.cbo.mfc.category.list"></md-query>
