  ...
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-crumbs>
        <md-part-toolbar-crumb>人员</md-part-toolbar-crumb>
    ...
    <md-part-body>
      <md-content>
        ...
        <md-input-container>
          <label>部门</label>
          <md-input-ref md-ref-id="suite.cbo.dept.ref" v-model="model.main.dept"></md-input-ref>
        </md-input-container>
      </md-content>
...
<script>
  ...
  export default {
    ...
    created() {
      this.model.entity='suite.cbo.person';
