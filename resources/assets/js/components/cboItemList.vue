<template>
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-group>
        <md-file-import md-entity="Suite\Cbo\Models\Item" template="/assets/vendor/suite-cbo/files/suite.cbo.item.xlsx"></md-file-import>
      </md-part-toolbar-group>
    ...
    <md-part-body class="no-padding">
      <md-query @select="select" :md-init="initQuery" @dblclick="edit" ref="list" md-query-id="suite.cbo.item.list"></md-query>
