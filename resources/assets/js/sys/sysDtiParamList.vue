<template>
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-group>
        <md-file-import md-entity="Gmf\Sys\Models\DtiParam" template="/assets/vendor/suite-cbo/files/suite.cbo.dti.param.xlsx"></md-file-import>
      </md-part-toolbar-group>
    ...
    <md-part-body class="no-padding">
      <md-query @select="select" @dblclick="edit" :md-init="initQuery" ref="list" md-query-id="gmf.sys.dti.param.list"></md-query>
    </md-part-body>
