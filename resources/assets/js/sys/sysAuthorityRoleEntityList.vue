<template>
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-group class="flex">
        <md-layout md-gutter md-align="end">
          ...
          <md-layout md-flex-small="33" md-flex-medium="15" md-flex-large="15">
            <md-ref-input md-label="实体" md-ref-id="gmf.sys.entity.ref" v-model="model.entity"></md-ref-input>
          </md-layout>
          <md-layout>
    ...
    <md-part-body class="no-padding">
      <md-query @select="select" @dblclick="edit" :md-init="initQuery" ref="list" md-query-id="gmf.sys.authority.role.entity.list"></md-query>
