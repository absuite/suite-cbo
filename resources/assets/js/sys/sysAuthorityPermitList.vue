<template>
  <md-part>
    ...
    <md-part-body class="no-padding">
      <md-query @select="select" @dblclick="edit" :md-init="initQuery" ref="list" md-query-id="gmf.sys.authority.permit.list"></md-query>
...
export default {
  ...
  methods: {
    ...
    remove() {
      ...
      this.$http.delete('sys/authority/permits/' + ids).then(response => {
        this.loadData();
        this.loading--;
