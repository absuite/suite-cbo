<template>
  <md-part>
    <md-part-toolbar>
      ...
      <md-part-toolbar-group>
        <cbo-file-import md-action="cbo/dti/import-items" template="/assets/vendor/suite-cbo/files/suite.cbo.dti.item.xlsx"></cbo-file-import>
      </md-part-toolbar-group>
    ...
    <md-part-body class="no-padding">
      <md-query @select="select" @dblclick="edit" @init="initQuery" ref="list" md-query-id="gmf.sys.dti.list"></md-query>
    </md-part-body>
